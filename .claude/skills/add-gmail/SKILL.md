...
>
> `@Lauren check my recent emails`
>
> Or:
>
> `@Lauren list my Gmail labels`
...
- **Email Address Pattern** - Emails to a specific address pattern (e.g., lauren+task@gmail.com) via plus-addressing
- **Subject Prefix** - Emails with a subject starting with a keyword (e.g., "[Lauren]")
...
Complete all Tool Mode steps above before continuing. Verify Gmail tools work by having the user test `@Lauren check my recent emails`.
